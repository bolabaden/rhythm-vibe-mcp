...
MSG_USE_LOCAL_OR_URL = "{exc} Use a local file path (relative to workdir) or a valid HTTP(S) URL."
...
MSG_FOR_TARGET_PASTE_ABC = (
    "For {target_format} output, paste ABC notation (X:/K:/body) or use normalize_reddit_music_text first."
)
...
MSG_COMPOSITION_PDF_SKIPPED = "composition generated; PDF render skipped (lilypond not found)"

...
def parse_chordpro_meta(text: str) -> ChordProMeta:
    ...
    Processing Logic:
    -------------------
        - High level explanation of parse_chordpro_meta logic.
...
def _directive_to_field(d: str) -> str:
    """Executes logic for _directive_to_field.
    ...
    Processing Logic:
    -------------------
        - High level explanation of _directive_to_field logic.
...
def extract_chordpro_title(text: str) -> str | None:
    ...
    Processing Logic:
    -------------------
        - High level explanation of extract_chordpro_title logic.
...
def extract_chordpro_chords(text: str) -> list[str]:
    ...
    Processing Logic:
    -------------------
        - High level explanation of extract_chordpro_chords logic.

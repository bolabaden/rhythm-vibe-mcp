...
def lilypond_key(key_name: str) -> str:
    r"""Return LilyPond \key syntax for the given key name.

    Args:
    ----
        key_name (Any): Description for key_name.
    ...
    Processing Logic:
    -------------------
        - High level explanation of lilypond_key logic.
...
def lilypond_time_sig(sig: str) -> str:
    ...
    Processing Logic:
    -------------------
        - High level explanation of lilypond_time_sig logic.
...
def lilypond_tempo(tempo_name: str) -> str:
    ...
    Args:
    ----
        tempo_name (Any): Description for tempo_name.
    ...
    Processing Logic:
    -------------------
        - High level explanation of lilypond_tempo logic.

...
from rhythm_vibe_mcp.constants.limits import CANDIDATE_ROUTES_MAX, ROUTE_MAX_DEPTH
...
def neighbors(format_name: str) -> set[str]:
    ...
    Args:
    ----
        format_name (Any): Description for format_name.
    ...
    Processing Logic:
    -------------------
        - High level explanation of neighbors logic.
...
def plan_conversion_route(source_format: str, target_format: str) -> list[str]:
    ...
    Processing Logic:
    -------------------
        - High level explanation of plan_conversion_route logic.
...
def candidate_conversion_routes(
    ...
    *,
    ...
    ----
        source_format (Any): Description for source_format.
        target_format (Any): Description for target_format.
        max_routes (Any): Description for max_routes.
        max_depth (Any): Description for max_depth.
    ...
    Processing Logic:
    -------------------
        - High level explanation of candidate_conversion_routes logic.

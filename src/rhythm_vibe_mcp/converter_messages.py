...
MSG_ABC_OUTPUT_NOT_SUPPORTED = (
    "ABC text conversion does not support output format: {output_format}"
)
...
def no_single_step_route(source_format: str, output_format: str) -> str:
    """Executes logic for no_single_step_route.

    Args:
    ----
        source_format (Any): Description for source_format.
    ...
    Processing Logic:
    -------------------
        - High level explanation of no_single_step_route logic.

    """
    return MSG_NO_SINGLE_STEP_ROUTE.format(
...
def requested_unsupported_direct(source_format: str, output_format: str) -> str:
    """Executes logic for requested_unsupported_direct.
    ...
    Processing Logic:
    -------------------
        - High level explanation of requested_unsupported_direct logic.

    """
    return MSG_REQUESTED_UNSUPPORTED_DIRECT.replace(
        "{source_format}",
        source_format,
...
def no_conversion_route(source_format: str, output_format: str) -> str:
    """Executes logic for no_conversion_route.
    ...
    Processing Logic:
    -------------------
        - High level explanation of no_conversion_route logic.

    """
    return MSG_NO_CONVERSION_ROUTE.format(
        source_format=source_format,
        output_format=output_format,
    )
...
def requested_unsupported_route(source_format: str, output_format: str) -> str:
    """Executes logic for requested_unsupported_route.
    ...
    Processing Logic:
    -------------------
        - High level explanation of requested_unsupported_route logic.

    """
    return MSG_REQUESTED_UNSUPPORTED_ROUTE.replace(
        "{source_format}",
        source_format,
    ).replace("{output_format}", output_format)
...
def conversion_stopped_at(from_fmt: str, to_fmt: str, route: list[str]) -> str:
    """Executes logic for conversion_stopped_at.

    Args:
    ----
        from_fmt (Any): Description for from_fmt.
        to_fmt (Any): Description for to_fmt.
        route (Any): Description for route.
    ...
    Processing Logic:
    -------------------
        - High level explanation of conversion_stopped_at logic.
...
def conversion_success_via_route(route: list[str]) -> str:
    """Executes logic for conversion_success_via_route.
    ...
    Processing Logic:
    -------------------
        - High level explanation of conversion_success_via_route logic.
...
def all_routes_failed(source_format: str, target_format: str) -> str:
    """Executes logic for all_routes_failed.

    Args:
    ----
        source_format (Any): Description for source_format.
        target_format (Any): Description for target_format.
    ...
    Processing Logic:
    -------------------
        - High level explanation of all_routes_failed logic.

    """
    return MSG_ALL_ROUTES_FAILED.format(
        source_format=source_format,

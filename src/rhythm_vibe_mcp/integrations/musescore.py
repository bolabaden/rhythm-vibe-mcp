...
from rhythm_vibe_mcp.constants.http import (
...
from rhythm_vibe_mcp.constants.limits import API_RESPONSE_TEXT_MAX_LEN
from rhythm_vibe_mcp.constants.musescore import (
    AUTH_BEARER_PREFIX,
    CONTENT_TYPE_JSON,
    MSG_HTTP_ERROR,
)
...
def musescore_api_request(
    ...
    from rhythm_vibe_mcp.constants.env import DEFAULT_MUSESCORE_BASE, ENV_MUSESCORE_BASE

    base_str = (
        base_url
        or os.getenv(ENV_MUSESCORE_BASE, DEFAULT_MUSESCORE_BASE)
        or DEFAULT_MUSESCORE_BASE
    )
    ...
    with httpx.Client(
        timeout=MUSESCORE_REQUEST_TIMEOUT,
